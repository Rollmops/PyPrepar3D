...
class InputEvent(BaseEvent):
    def __init__(self, trigger, sim_event='', callback=None, state=SIMCONNECT_STATE.SIMCONNECT_STATE_ON, priority=SIMCONNECT_GROUP_PRIORITY_HIGHEST, register=True, enabled=None, at_sim_start=False):
