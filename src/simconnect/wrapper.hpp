...
HRESULT addToDataDefinition(PyObject *, SIMCONNECT_DATA_DEFINITION_ID, const char*, const char*, SIMCONNECT_DATATYPE, float, DWORD);

HRESULT changeVehicle(PyObject*, const char *);

HRESULT clearClientDataDefinition(PyObject *, SIMCONNECT_CLIENT_DATA_DEFINITION_ID);
...
HRESULT createClientData(PyObject *, SIMCONNECT_CLIENT_DATA_ID, DWORD, SIMCONNECT_CREATE_CLIENT_DATA_FLAG);
